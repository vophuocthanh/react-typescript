...
const App = () => {
  ...
  return (
    <div>
      ...
      ></List>
      <Boxed>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias at esse
        in quibusdam! Delectus amet magnam nobis repellendus omnis praesentium
        consequuntur expedita iste ab, voluptatum ex laboriosam iusto distinctio
        debitis.
      </Boxed>
