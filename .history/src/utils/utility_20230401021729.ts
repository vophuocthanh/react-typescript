...
type TodoPreviewOmit = Omit<TodoOmit, "description" | "createdAt">; // loại thằng description và createAt
const todo2: TodoPreviewOmit = {
  title: "Clean room",
  completed: false,
};
...
// NonNullable<Type>
type T3 = NonNullable<string | number | undefined>; // => string | number, loại trừ undefined
